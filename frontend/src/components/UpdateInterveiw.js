...
const UpdateInterview = ({
  ...
  return (
    <>
      ...
      <div
        className={`shadow-2xl bg-gray-50 text-gray-900 rounded-lg fixed top-0 left-0 right-0 z-50 m-auto max-w-5xl  h-11/12 border mt-10 mb-10  w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 ${
          !collapse && "hidden"
        }`}
      >
